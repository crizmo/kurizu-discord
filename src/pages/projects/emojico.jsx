    ...
    const messages = [
        {
            ...
            message: "EmojiCo is a web-based tool that allows you to easily add emojis to your commit messages. <br>" +
                ...
                "You can check out EmojiCo <a href='https://emojico.vercel.app' target='_blank'>https://emojico.vercel.app</a>\n\n" +
        ...
        },
        {
            ...
            message: "Oh, and the code is open source too! <br>" +
                ...
                "<a href='https://github.com/crizmo/EmojiCo' target='_blank'>Github</a><br>" +
                "<a href='https://emojico.vercel.app' target='_blank'>Website</a><br>" +
